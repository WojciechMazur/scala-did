...
case class SimpleIndentity(didSubject: DIDSubject, keys: Seq[PrivateKey]) extends Indentity {
  def id: DID = didSubject
}
object SimpleIndentity {
  given JsonDecoder[SimpleIndentity] = DeriveJsonDecoder.gen[SimpleIndentity]
  given JsonEncoder[SimpleIndentity] = DeriveJsonEncoder.gen[SimpleIndentity]
}

case class SignOpInput(agent: SimpleIndentity, msg: PlaintextMessage) extends OpsInputRPC
...
case class AuthEncryptOpInput(agent: SimpleIndentity, /*resolver: Resolver,*/ msg: PlaintextMessage) extends OpsInputRPC
case class AuthEncryptOpOutput(ret: Either[DidFail, EncryptedMessage]) extends OpsOutputPRC
case class AuthDecryptOpInput(agent: SimpleIndentity, /*resolver: Resolver,*/ msg: EncryptedMessage) extends OpsInputRPC
...
case class AnonDecryptOpInput(agent: SimpleIndentity, msg: EncryptedMessage) extends OpsInputRPC
