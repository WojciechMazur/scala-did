...
object AgentProvider {
  ...
  def aliceLayer: ZIO[AgentProvider, Nothing, Indentity] = ZIO.serviceWith(_.alice)
  def patLayer: ZIO[AgentProvider, Nothing, Indentity] = ZIO.serviceWith(_.pat)
  def daveLayer: ZIO[AgentProvider, Nothing, Indentity] = ZIO.serviceWith(_.dave)
  def bobLayer: ZIO[AgentProvider, Nothing, Indentity] = ZIO.serviceWith(_.bob)
  def eveLayer: ZIO[AgentProvider, Nothing, Indentity] = ZIO.serviceWith(_.eve)
  def charlieLayer: ZIO[AgentProvider, Nothing, Indentity] = ZIO.serviceWith(_.charlie)
  def ivanLayer: ZIO[AgentProvider, Nothing, Indentity] = ZIO.serviceWith(_.ivan)
  def victorLayer: ZIO[AgentProvider, Nothing, Indentity] = ZIO.serviceWith(_.victor)
...
case class AgentProvider(prod: Boolean, port: Option[Int]) {
  ...
  val alice = DIDPeer2.makeIndentity(
    Seq(
  ...
  val bob = DIDPeer2.makeIndentity(
    Seq(
  ...
  val charlie = DIDPeer2.makeIndentity(
    Seq(
  ...
  val pat = DIDPeer2.makeIndentity(
    Seq(
  ...
  val dave = DIDPeer2.makeIndentity(
    Seq(
  ...
  val ivan = DIDPeer2.makeIndentity(
    Seq(
  ...
  val eve = DIDPeer2.makeIndentity(
    Seq(
  ...
  val frank = DIDPeer2.makeIndentity(
    Seq(
  ...
  val victor = DIDPeer2.makeIndentity(
    Seq(
